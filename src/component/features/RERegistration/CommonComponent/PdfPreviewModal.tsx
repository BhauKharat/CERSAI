    ...
    >
      ...
      >
        {!isSignedDocument
          ...
          : 'Reporting Entity Digitally Signed Registration Form'}
        <IconButton
          onClick={handleClose}
          sx={{
            color: '#666',
          ...
          {pdfDocument && !loading && !error && (
            ...
            >
              <iframe
                ...
                title="RE Registration Form PDF"
      ...
      >
        {!isSignedDocument ? (
            ...
            >
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <TextField
                  ...
                  value={place}
                  onChange={(e) =>
                    setPlace(e.target.value.replace(/[^a-zA-Z\s]/g, ''))
                  }
          ...
          /* Signed Document State - Back to Home Button */
          <Box
            sx={{
              display: 'flex',
              justifyContent: 'center',
