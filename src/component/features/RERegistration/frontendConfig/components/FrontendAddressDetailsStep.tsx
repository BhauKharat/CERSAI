...
import FrontendDynamicExpandCollapseForm from '../FrontendDynamicExpandCollapseForm';
...
const FrontendAddressDetailsStep: React.FC<FrontendAddressDetailsStepProps> = ({
  ...
  // Ensure fields are set before rendering FrontendDynamicExpandCollapseForm
    ...
    <>
      ...
      <FormErrorBoundary>
        <FieldErrorProvider fieldErrors={fieldErrors}>
          ...
          <FrontendDynamicExpandCollapseForm
