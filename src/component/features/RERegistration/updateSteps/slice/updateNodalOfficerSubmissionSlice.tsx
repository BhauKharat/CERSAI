...
export const submitUpdatedNodalOfficerDetails = createAsyncThunk(
  'nodalOfficerSubmission/submitNodalOfficerDetails',
  async (
    {
      formValues,
      userId,
    ...
    try {
      console.log(
        '📥 Received formValues for Nodal Officer submission:',
        formValues
      );
      ...
      console.log('📦 FormData structure for Nodal Officer submission:');
      ...
      const response = await Secured.put(
        API_ENDPOINTS.submit_update_nodal_officer_details,
        formData,
        {
          headers: {
      ...
      console.log(
        '✅ Nodal Officer details submission successful:',
        response.data
      );
      return response.data as NodalOfficerSubmissionResponse;
    } catch (error: unknown) {
      console.error('❌ Nodal Officer details submission failed:', error);
      ...
      if (error && typeof error === 'object' && 'response' in error) {
        ...
        const errorMessage =
          ...
          axiosError.message ||
          'Failed to submit Nodal Officer details';
