...
import { PageContainer, ContentBox, SectionDivider } from './SearchKYC.styles';

import ArrowBackIcon from '@mui/icons-material/ArrowBack';
import Tab from '@mui/material/Tab';
import Tabs from '@mui/material/Tabs';

import SingleKYCSearch from './SingleKYCSearch'; // Import the new Single component
import BulkKYCSearch from './BulkKYCSearch'; // Import the new Bulk component
