...
import LegalKYCUpdateForm from './LegalKYCUpdateForm';

const SingleKYCUpdate: React.FC<SingleKYCDownloadProps> = ({
  entityType,
  setEntityType,
  setSearchType,
  setSearchValue,
    ...
    <React.Fragment>
      ...
      {entityType === 'individual' && (
        <>
          ...
          {refrenceSearchAttempted && <KYCUpdateForm />}
        </>
      )}
      ...
      {entityType === 'legal' && (
        <>
          ...
          {refrenceSearchAttempted && <LegalKYCUpdateForm />}
        </>
      )}
    </React.Fragment>
  );
...
export default SingleKYCUpdate;
