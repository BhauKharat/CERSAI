...
const menuItems: MenuItemType[] = [
  ...
  {
    label: 'Dashboard',
    icon: '/ckyc/icons/Dashboards.png',
    to: '/ckycrr-admin/my-task/dashboard',
  },
  {
    label: 'RE Registration',
    icon: '/ckyc/icons/Registration.png',
    children: [
      {
        label: 'Track Status',
  ...
  // },
  {
    ...
    children: [
      {
        label: 'Search KYC Record',
        to: '/ckycrr-admin/kyc/search',
      },
      {
        label: 'Download KYC Record',
        to: '/ckycrr-admin/kyc/download',
      },
      {
        label: 'Create KYC Record',
        to: '/ckycrr-admin/kyc/create',
      },
      {
        label: 'Update KYC Record',
        to: '/ckycrr-admin/kyc/update',
      },
    ],
  },
  {
    label: 'Billing Management System',
    icon: '/ckyc/icons/BillingManagementSystem.png',
    children: [
      {
        label: 'Billing Overview',
        to: '/ckycrr-admin/billing/overview',
      },
      {
        label: 'Payment History',
        to: '/ckycrr-admin/billing/payment-history',
      },
      {
        label: 'Invoices',
        to: '/ckycrr-admin/billing/invoices',
      },
    ],
  },
  // {
  ...
  {
    label: 'RE Management',
    icon: '/ckyc/icons/Simplification1.png',
    children: [
      {
        label: 'De-activation',
  ...
  },
  {
    ...
    icon: '/ckyc/icons/Consolidation.png',
    children: [
      {
        label: 'Consolidation Requests',
        to: '/ckycrr-admin/re-consolidation/requests',
      },
      {
        label: 'Track Status',
        to: '/ckycrr-admin/re-consolidation/track-status',
      },
    ],
  },
  {
    label: 'RE De-activation',
    icon: '/ckyc/icons/de-activation.png',
    children: [
      {
        label: 'De-activation Requests',
        to: '/ckycrr-admin/re-deactivation/requests',
      },
      {
        label: 'Track Status',
        to: '/ckycrr-admin/re-deactivation/track-status',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        to: '/ckycrr-admin/ip-whitelisting/view-whitelisted-ips',
      },
      {
        label: 'Block IPs',
        to: '/ckycrr-admin/ip-whitelisting/block-ips',
      },
      {
        label: 'Unblock IPs',
        to: '/ckycrr-admin/ip-whitelisting/unblock-ips',
      },
      {
        label: 'Track Status',
        to: '/ckycrr-admin/ip-whitelisting/track-status',
      },
    ],
  },
  {
    label: 'MIS reports',
    icon: '/ckyc/icons/MIS reports .png',
    to: '/ckycrr-admin/mis-reports',
  },
  {
    ...
    children: [
      {
        label: 'All Tickets',
        to: '/ckycrr-admin/tickets/all',
      },
      {
        label: 'Create Ticket',
        to: '/ckycrr-admin/tickets/create',
      },
      {
        label: 'Track Status',
        to: '/ckycrr-admin/tickets/track-status',
      },
    ],
  },
  {
    label: 'Training',
    icon: '/ckyc/icons/training .png',
    children: [
      {
        label: 'Training Materials',
        to: '/ckycrr-admin/training/materials',
      },
      {
        label: 'Training Schedule',
        to: '/ckycrr-admin/training/schedule',
      },
      {
        label: 'Certifications',
        to: '/ckycrr-admin/training/certifications',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        to: '/ckycrr-admin/bo-registry/overview',
      },
      {
        label: 'Search Registry',
        to: '/ckycrr-admin/bo-registry/search',
      },
      {
        label: 'Update Registry',
        to: '/ckycrr-admin/bo-registry/update',
      },
    ],
  },
];
